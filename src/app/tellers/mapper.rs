...
pub struct TellerFlat {
    ...
    pub supervisor_employee_number: Option<String>,
    pub supervisor_full_name: Option<String>,
    pub supervisor_first_name: Option<String>,
    pub supervisor_last_name: Option<String>,
    pub supervisor_phone_number: Option<String>,
    pub supervisor_email_address: Option<String>,
    ...
    fn from(value: TellerFlat) -> Self {
        Self {
            ...
            supervisor: value.supervisor_id.map(|id| StaffSummary {
                id: id.to_string(),
                employee_number: value.supervisor_employee_number.unwrap_or_default(),
                full_name: value.supervisor_full_name,
                first_name: value.supervisor_first_name.unwrap_or_default(),
                last_name: value.supervisor_last_name.unwrap_or_default(),
                phone_number: value.supervisor_phone_number.unwrap_or_default(),
                email_address: value.supervisor_email_address.unwrap_or_default(),
