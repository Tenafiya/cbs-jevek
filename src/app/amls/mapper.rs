...
pub struct AmlRuleFlat {
    ...
    pub updater_employee_number: Option<String>,
    pub updater_full_name: Option<String>,
    pub updater_first_name: Option<String>,
    pub updater_last_name: Option<String>,
    pub updater_phone_number: Option<String>,
    pub updater_email_address: Option<String>,
    ...
    fn from(value: AmlRuleFlat) -> Self {
        Self {
            ...
            creator: value.creator_id.map(|id| StaffSummary {
                id: id.to_string(),
                employee_number: value.creator_employee_number.unwrap_or_default(),
                full_name: value.creator_full_name,
                first_name: value.creator_first_name.unwrap_or_default(),
                last_name: value.creator_last_name.unwrap_or_default(),
                phone_number: value.creator_phone_number.unwrap_or_default(),
                email_address: value.creator_email_address.unwrap_or_default(),
            ...
            updater: value.updater_id.map(|id| StaffSummary {
                id: id.to_string(),
                employee_number: value.updater_employee_number.unwrap_or_default(),
                full_name: value.updater_full_name,
                first_name: value.updater_first_name.unwrap_or_default(),
                last_name: value.updater_last_name.unwrap_or_default(),
                phone_number: value.updater_phone_number.unwrap_or_default(),
                email_address: value.updater_email_address.unwrap_or_default(),
...
pub struct AmlCaseFlat {
    ...
    pub investigator_employee_number: Option<String>,
    pub investigator_full_name: Option<String>,
    pub investigator_first_name: Option<String>,
    pub investigator_last_name: Option<String>,
    pub investigator_phone_number: Option<String>,
    pub investigator_email_address: Option<String>,
    ...
    pub resolved_by_employee_number: Option<String>,
    pub resolved_by_full_name: Option<String>,
    pub resolved_by_first_name: Option<String>,
    pub resolved_by_last_name: Option<String>,
    pub resolved_by_phone_number: Option<String>,
    pub resolved_by_email_address: Option<String>,
    ...
    fn from(value: AmlCaseFlat) -> Self {
        Self {
            ...
            assigned_investigator: value.assigned_investigator.map(|id| StaffSummary {
                id: id.to_string(),
                employee_number: value.investigator_employee_number.unwrap_or_default(),
                full_name: value.investigator_full_name,
                first_name: value.investigator_first_name.unwrap_or_default(),
                last_name: value.investigator_last_name.unwrap_or_default(),
                phone_number: value.investigator_phone_number.unwrap_or_default(),
                email_address: value.investigator_email_address.unwrap_or_default(),
            ...
            resolved_by: value.resolved_by.map(|id| StaffSummary {
                id: id.to_string(),
                employee_number: value.resolved_by_employee_number.unwrap_or_default(),
                full_name: value.resolved_by_full_name,
                first_name: value.resolved_by_first_name.unwrap_or_default(),
                last_name: value.resolved_by_last_name.unwrap_or_default(),
                phone_number: value.resolved_by_phone_number.unwrap_or_default(),
                email_address: value.resolved_by_email_address.unwrap_or_default(),
...
pub struct AmlAlertFlat {
    ...
    pub case_status: Option<AmlCaseStatus>,
    pub case_priority: Option<AmlCasesPriority>,
...
impl TryFrom<AmlAlertFlat> for AmlAlertRow {
    ...
    fn try_from(flat: AmlAlertFlat) -> Result<Self, Self::Error> {
        let amount =
            conversions::major_conversion(flat.transaction_amount.unwrap_or_default(), "GHS");
        ...
        Ok(Self {
            ...
            case_id: flat.case_id.map(|id| AmlCaseSummary {
                id: id.to_string(),
                case_number: flat.case_number.unwrap_or_default(),
                title: flat.case_title.unwrap_or_default(),
                description: flat.case_description,
                priority: flat.case_priority.unwrap_or_default(),
                status: flat.case_status.unwrap_or_default(),
            }),
            ...
            transaction_id: flat.transaction_id.map(|id| TransactionSummary {
                ...
                transaction_group_id: flat.transaction_group_id.unwrap_or_default(),
                transaction_type: flat.transaction_type.unwrap_or_default(),
                transaction_category: flat.transaction_category.unwrap_or_default(),
                amount,
                currency: flat.transaction_currency,
                status: flat.transaction_status.unwrap_or_default(),
