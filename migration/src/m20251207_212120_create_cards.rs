...
impl MigrationTrait for Migration {
    async fn up(&self, manager: &SchemaManager) -> Result<(), DbErr> {
        ...
        let cards = Table::create()
            ...
            .col(ColumnDef::new(Cards::DailyAtmLimit).big_integer())
            .col(ColumnDef::new(Cards::DailyPosLimit).big_integer())
            .col(ColumnDef::new(Cards::DailyOnlineLimit).big_integer())
